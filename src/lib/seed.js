 ...
 *  - 매일 채우지 않는다. 3·6·11일 전은 비워서 스트릭이 자연스럽게 끊겼다 이어지게 한다.
...
const SESSION_PLAN = [
  ...
  { daysAgo: 5, gameId: 'cooking', domain: '실행기능', level: 2, score: 75, accuracy: 0.78, durationSec: 196 },
